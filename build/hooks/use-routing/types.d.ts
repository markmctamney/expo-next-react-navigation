...
export declare type Params<P> = {
    params: P;
};
export declare type WebRoute<Path extends string | undefined, As extends string = ''> = {
    web: {
        path?: Path;
        as?: As;
    };
};
export declare type NavigateFunction<NavigateTo> = (route: NavigateTo) => void;
export declare type PushFunction<NavigateTo> = (route: NavigateTo) => void;
export declare type GetParam<Param extends unknown = undefined> = (param: string) => Param;
export declare type ReturnNav = {
